...
generatedAt: 2025-12-30T18:14:51.392Z
---
...
#### [Styles to CSS rules](#styles-to-css-rules)
...
#### [Settings to CSS rules](#settings-to-css-rules)
...
#### [1\. Setting a different CSS selector for blocks requires server-registration](#1-setting-a-different-css-selector-for-blocks-requires-server-registration)
...
#### [2\. Can’t target different HTML nodes for different styles](#2-cant-target-different-html-nodes-for-different-styles)
...
#### [3\. Only a single property per block](#3-only-a-single-property-per-block)
...
#### [4\. Only blocks using block supports are shown in the Global Styles UI](#4-only-blocks-using-block-supports-are-shown-in-the-global-styles-ui)
