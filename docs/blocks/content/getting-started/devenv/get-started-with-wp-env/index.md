...
generatedAt: 2025-12-30T18:14:55.354Z
---
...
## [Set up Docker Desktop](#set-up-docker-desktop)
...
## [Install and run wp-env](#install-and-run-wp-env)
...
### [Where to run wp-env](#where-to-run-wp-env)
...
### [Uninstall or reset wp-env](#uninstall-or-reset-wp-env)
...
### [Ubuntu Docker setup](#ubuntu-docker-setup)
