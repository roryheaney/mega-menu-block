...
generatedAt: 2025-12-30T18:14:56.734Z
---

When developing for the Block Editor, you will need [Node.js](https://nodejs.org/en) development tools along with a code editor and a local WordPress environment (see [Block Development Environment](https://developer.wordpress.org/block-editor/getting-started/devenv/)). Node.js (`node`) is an open-source runtime environment that allows you to execute JavaScript code from the terminal (also known as a command-line interface, CLI, or shell)
...
## [Node.js installation on Mac and Linux (with nvm)](#node-js-installation-on-mac-and-linux-with-nvm)
...
## [Node.js installation on Windows and others](#node-js-installation-on-windows-and-others)
