...
generatedAt: 2025-12-30T18:15:03.611Z
---
...
## [Extending the block with variations](#extending-the-block-with-variations)
...
### [1\. Offer sensible defaults](#1-offer-sensible-defaults)
...
### [2\. Customize your variation layout](#2-customize-your-variation-layout)
...
### [3\. Making Gutenberg recognize your variation](#3-making-gutenberg-recognize-your-variation)
...
## [Extending the query](#extending-the-query)
...
### [Disabling irrelevant or unsupported query controls](#disabling-irrelevant-or-unsupported-query-controls)
...
### [Understanding the taxQuery structure](#understanding-the-taxquery-structure)
...
### [Adding additional controls](#adding-additional-controls)
...
### [Making your custom query work on the front-end side](#making-your-custom-query-work-on-the-front-end-side)
...
### [Making your custom query work on the editor side](#making-your-custom-query-work-on-the-editor-side)
