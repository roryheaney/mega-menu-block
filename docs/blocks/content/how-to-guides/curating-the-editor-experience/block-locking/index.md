...
generatedAt: 2025-12-30T18:15:04.584Z
---
...
## [Lock the ability to move or remove specific blocks](#lock-the-ability-to-move-or-remove-specific-blocks)
...
## [Lock the ability to edit certain blocks](#lock-the-ability-to-edit-certain-blocks)
...
## [Apply block locking to patterns or templates](#apply-block-locking-to-patterns-or-templates)
...
## [Apply content-only editing in patterns or templates](#apply-content-only-editing-in-patterns-or-templates)
...
## [Change permissions to control locking ability](#change-permissions-to-control-locking-ability)
...
Developers can add a filter to the [block\_editor\_settings\_all](https://developer.wordpress.org/reference/hooks/block_editor_settings_all/) hook to configure permissions around locking blocks. The hook passes two parameters to the callback function:

*   `$settings` – An array of configurable settings for the Editor.
*   `$context` – An instance of [WP\_Block\_Editor\_Context](https://developer.wordpress.org/reference/classes/wp_block_editor_context/), an object that contains information about the current Editor.
