...
generatedAt: 2025-12-30T18:15:05.938Z
---
...
## [Server-side theme.json filters](#server-side-theme-json-filters)
...
## [Client-side (Editor) filters](#client-side-editor-filters)

WordPress 6.2 introduced a new client-side filter allowing you to modify block-level [theme.json settings](https://developer.wordpress.org/block-editor/reference-guides/theme-json-reference/theme-json-living/#settings) before the Editor is rendered.
