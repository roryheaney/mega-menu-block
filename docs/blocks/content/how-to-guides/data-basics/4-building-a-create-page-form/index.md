...
generatedAt: 2025-12-30T18:15:09.804Z
---

In the [previous part](https://developer.wordpress.org/block-editor/how-to-guides/data-basics/3-building-an-edit-form/) we created an _Edit page_ feature, and in this part we will add a _Create page_ feature. Here’s a glimpse of what we’re going to build:
...
### [Step 1: Add a Create a new page button](#step-1-add-a-create-a-new-page-button)

Let’s start by building a button to display the _create page_ form. It’s similar to an _Edit_ button we have built in the [part 3](https://developer.wordpress.org/block-editor/how-to-guides/data-basics/3-building-an-edit-form/):
...
### [Step 2: Extract a controlled PageForm](#step-2-extract-a-controlled-pageform)
...
### [Step 3: Build a CreatePageForm](#step-3-build-a-createpageform)
...
#### [Title, onChangeTitle, hasEdits](#title-onchangetitle-hasedits)
...
#### [lastError, isSaving](#lasterror-issaving)
...
*   **Next part:** [Adding a delete button](https://developer.wordpress.org/block-editor/how-to-guides/data-basics/5-adding-a-delete-button/)
*   **Previous part:** [Building an edit form](https://developer.wordpress.org/block-editor/how-to-guides/data-basics/3-building-an-edit-form/)
