...
generatedAt: 2025-12-30T18:14:28.566Z
---
...
### [Step 1: Register a new format](#step-1-register-a-new-format)
...
### [Step 2: Add a button to the toolbar](#step-2-add-a-button-to-the-toolbar)
...
### [Step 3: Apply a format when clicked](#step-3-apply-a-format-when-clicked)
...
### [Step 4: Show the button only for specific blocks (Optional)](#step-4-show-the-button-only-for-specific-blocks-optional)
...
### [Step 5: Add a button outside of the dropdown (Optional)](#step-5-add-a-button-outside-of-the-dropdown-optional)
