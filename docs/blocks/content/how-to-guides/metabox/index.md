...
generatedAt: 2025-12-30T18:14:29.481Z
---
...
### [Use blocks to store meta](#use-blocks-to-store-meta)
...
This guide assumes you are already familiar with WordPress plugins, post meta, and basic JavaScript. Review the [Getting started with JavaScript tutorial](https://developer.wordpress.org/block-editor/getting-started/fundamentals/javascript-in-the-block-editor/) for an introduction.
...
### [Step 1: Register meta field](#step-1-register-meta-field)
...
### [Step 2: Add meta block](#step-2-add-meta-block)
...
### [Step 3: Use post meta data](#step-3-use-post-meta-data)
...
#### [Use post meta in a block](#use-post-meta-in-a-block)
...
In PHP, use the [register\_block\_type](https://developer.wordpress.org/reference/functions/register_block_type/) function to set a callback when the block is rendered to include the meta value.
...
### [Step 4: Use block templates (optional)](#step-4-use-block-templates-optional)

One problem using a meta block is the block is easy for an author to forget, since it requires being added to each post. You solve this by using [block templates](https://developer.wordpress.org/block-editor/reference-guides/block-api/block-templates/). A block template is a predefined list of block items per post type. Templates allow you to specify a default initial state for a post type.
...
### [Testing, converting, and maintaining existing meta boxes](#testing-converting-and-maintaining-existing-meta-boxes)
...
### [Meta box data collection](#meta-box-data-collection)
...
### [Redux and React meta box management](#redux-and-react-meta-box-management)
...
#### [MetaBoxArea component](#metaboxarea-component)
