...
generatedAt: 2025-12-30T18:15:13.263Z
---
...
### [Registering the page](#registering-the-page)
...
### [Adding the target HTML](#adding-the-target-html)
...
### [Enqueuing JavaScript and CSS](#enqueuing-javascript-and-css)
...
### [Inlining the editor settings](#inlining-the-editor-settings)
...
### [Understanding the <BlockEditorProvider> component](#understanding-the-blockeditorprovider-component)
...
#### [BlockEditor props](#blockeditor-props)
...
### [Understanding the <BlockList> component](#understanding-the-blocklist-component)
...
#### [How does BlockList work?](#how-does-blocklist-work)
...
### [Storing blocks in state](#storing-blocks-in-state)
...
### [Saving block data](#saving-block-data)
...
### [Retrieving previous block data](#retrieving-previous-block-data)
