...
generatedAt: 2025-12-30T18:14:31.532Z
---
...
## [Recommendations on managing updates](#recommendations-on-managing-updates)

### [Establish early what content you expect to require updates](#establish-early-what-content-you-expect-to-require-updates)
...
### [Embrace theme design at the block level](#embrace-theme-design-at-the-block-level)
...
## [Content types (and how to properly update them)](#content-types-and-how-to-properly-update-them)
...
### [Synced Patterns](#synced-patterns)
...
### [Template parts and templates](#template-parts-and-templates)
