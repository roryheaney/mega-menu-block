...
generatedAt: 2025-12-30T18:15:16.620Z
---
...
## [Compatibility with the Legacy Widget block](#compatibility-with-the-legacy-widget-block)

### [The widget-added event](#the-widget-added-event)
...
### [Displaying “No preview available.”](#displaying-no-preview-available)
...
### [Allowing migration to a block](#allowing-migration-to-a-block)
...
#### [1) Display the widget’s instance in the REST API](#1-display-the-widgets-instance-in-the-rest-api)
...
#### [2) Add a block transform](#2-add-a-block-transform)
...
#### [3) Hide the widget from the Legacy Widget block](#3-hide-the-widget-from-the-legacy-widget-block)
...
## [Using the Legacy Widget block in other block editors (Advanced)](#using-the-legacy-widget-block-in-other-block-editors-advanced)
