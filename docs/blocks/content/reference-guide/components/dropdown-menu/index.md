...
title: "DropdownMenu"
slug: "dropdown-menu"
source: "https://developer.wordpress.org/block-editor/reference-guide/components/dropdown-menu/"
generatedAt: 2025-12-30T18:15:24.307Z
---
...
#### [When to use a DropdownMenu](#when-to-use-a-dropdownmenu)
...
#### [controls: DropdownOption\[\] | DropdownOption\[\]\[\]](#controls-dropdownoption-dropdownoption)
...
#### [children: ( callbackProps: DropdownCallbackProps ) => ReactNode](#children-callbackprops-dropdowncallbackprops-reactnode)
...
#### [popoverProps: DropdownProps\[ ‘popoverProps’ \]](#popoverprops-dropdownprops-popoverprops)
...
#### [toggleProps: ToggleProps](#toggleprops-toggleprops)
...
#### [menuProps: NavigableContainerProps](#menuprops-navigablecontainerprops)
...
#### [disableOpenOnArrowDown: boolean](#disableopenonarrowdown-boolean)
...
### [onToggle: ( willOpen: boolean ) => void](#ontoggle-willopen-boolean-void)
