...
title: "Modal"
slug: "modal"
source: "https://developer.wordpress.org/block-editor/reference-guide/components/modal/"
generatedAt: 2025-12-30T18:15:28.591Z
---
...
### [Modal box and scrim](#modal-box-and-scrim)
...
#### [Side-by-side buttons (recommended)](#side-by-side-buttons-recommended)
...
#### [Stacked or full-width buttons](#stacked-or-full-width-buttons)
...
#### [bodyOpenClassName: string](#bodyopenclassname-string)
...
#### [focusOnMount: boolean | ‘firstElement’ | ‘firstContentElement’](#focusonmount-boolean-firstelement-firstcontentelement)
...
#### [size: ‘small’ | ‘medium’ | ‘large’ | ‘fill’](#size-small-medium-large-fill)
...
#### [\_\_experimentalHideHeader: boolean](#__experimentalhideheader-boolean)
