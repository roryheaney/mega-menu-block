...
source: "https://developer.wordpress.org/block-editor/reference-guide/packages/packages-editor/"
generatedAt: 2025-12-30T18:15:41.849Z
---
...
This replicates some of what [sanitize\_title()](https://developer.wordpress.org/reference/functions/sanitize_title/) does in WordPress core, but is only designed to approximate what the slug will be.
...
### [EditorKeyboardShortcutsRegister](#editorkeyboardshortcutsregister)
...
### [LocalAutosaveMonitor](#localautosavemonitor)
...
### [PageAttributesOrder](#pageattributesorder)
...
*   _props.other_ `[...*]`: Any additional props are passed through to the underlying [Button](https://developer.wordpress.org/block-editor/reference-guide/components/button/) component.
...
### [PostAuthorPanel](#postauthorpanel)
...
### [PostExcerptCheck](#postexcerptcheck)
...
### [PostFeaturedImageCheck](#postfeaturedimagecheck)
...
### [PostLastRevision](#postlastrevision)
...
### [PostLastRevisionCheck](#postlastrevisioncheck)
...
### [PostLastRevisionPanel](#postlastrevisionpanel)
...
### [PostPublishButtonLabel](#postpublishbuttonlabel)
...
### [PostTaxonomiesFlatTermSelector](#posttaxonomiesflattermselector)
...
### [PostTaxonomiesHierarchicalTermSelector](#posttaxonomieshierarchicaltermselector)
...
### [PostTaxonomiesPanel](#posttaxonomiespanel)
...
### [PostTypeSupportCheck](#posttypesupportcheck)
...
### [userAutocompleter](#userautocompleter)
