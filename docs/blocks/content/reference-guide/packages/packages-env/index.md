...
title: "@wordpress/env"
slug: "packages-env"
source: "https://developer.wordpress.org/block-editor/reference-guide/packages/packages-env/"
generatedAt: 2025-12-30T18:15:44.260Z
---

`wp-env` lets you easily set up a local WordPress environment for building and testing plugins and themes. It’s simple to install and requires no configuration.

## [Quick (tl;dr) instructions](#quick-tldr-instructions)
...
### [Installation as a local package](#installation-as-a-local-package)
...
### [1\. Check that wp-env is running](#1-check-that-wp-env-is-running)
...
### [2\. Check the port number](#2-check-the-port-number)
...
### [3\. Restart wp-env with updates](#3-restart-wp-env-with-updates)
...
### [5\. Reset the database](#5-reset-the-database)
...
### [6\. Destroy everything and start again 🔥](#6-destroy-everything-and-start-again-%f0%9f%94%a5)
...
## [Using included WordPress PHPUnit test files](#using-included-wordpress-phpunit-test-files)
...
### [Customizing the wp-tests-config.php file](#customizing-the-wp-tests-config-php-file)
...
## [Using composer, phpunit, and wp-cli tools.](#using-composer-phpunit-and-wp-cli-tools)
...
### [Xdebug IDE support](#xdebug-ide-support)
...
### [wp-env clean \[environment\]](#wp-env-clean-environment)
...
### [wp-env run <container> \[command…\]](#wp-env-run-container-command)
...
#### [Displaying the users on the development instance:](#displaying-the-users-on-the-development-instance)
...
#### [Creating a post on the tests instance:](#creating-a-post-on-the-tests-instance)
...
#### [Opening the WordPress shell on the tests instance and running PHP commands:](#opening-the-wordpress-shell-on-the-tests-instance-and-running-php-commands)
...
#### [Installing a plugin or theme on the development instance](#installing-a-plugin-or-theme-on-the-development-instance)
...
#### [Changing the permalink structure](#changing-the-permalink-structure)
...
### [wp-env logs \[environment\]](#wp-env-logs-environment)
...
### [wp-env install-path](#wp-env-install-path)
...
`"WordPress/WordPress"`, `"WordPress/gutenberg#trunk"`, `WordPress/themes/my-theme#my-branch`; if no branch is provided wp-env will fall back to the repo’s default branch

SSH repository

`ssh://user@host/<owner>/<repo>.git[#<ref>]`

`"ssh://git@github.com/WordPress/WordPress.git"`

ZIP File

`http[s]://<host>/<path>.zip`
...
## [Default wp-config values.](#default-wp-config-values)
...
### [Latest stable WordPress + current directory as a plugin](#latest-stable-wordpress-current-directory-as-a-plugin)
...
### [Latest development WordPress + current directory as a plugin](#latest-development-wordpress-current-directory-as-a-plugin)
...
### [Local wordpress-develop + current directory as a plugin](#local-wordpress-develop-current-directory-as-a-plugin)
...
### [A complete testing environment](#a-complete-testing-environment)
...
### [Add mu-plugins and other mapped directories](#add-mu-plugins-and-other-mapped-directories)
...
### [Avoid activating plugins or themes on the instance](#avoid-activating-plugins-or-themes-on-the-instance)
...
### [Map a plugin only in the tests environment](#map-a-plugin-only-in-the-tests-environment)
...
### [Specific PHP Version](#specific-php-version)
...
### [Node Lifecycle Script](#node-lifecycle-script)
...
### [Advanced PHP settings](#advanced-php-settings)
...
### [Using SPX Profiling](#using-spx-profiling)
