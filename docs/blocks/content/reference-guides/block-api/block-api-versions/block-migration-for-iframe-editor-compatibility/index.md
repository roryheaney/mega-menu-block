...
source: "https://developer.wordpress.org/block-editor/reference-guides/block-api/block-api-versions/block-migration-for-iframe-editor-compatibility/"
generatedAt: 2025-12-30T18:19:13.619Z
---
...
## [What is the iframe editor?](#what-is-the-iframe-editor)

### [Benefits of the iframe editor](#benefits-of-the-iframe-editor)
...
### [When does the post editor work as an iframe?](#when-does-the-post-editor-work-as-an-iframe)
...
### [When will the post editor work as an iframe?](#when-will-the-post-editor-work-as-an-iframe)
...
## [How to test your blocks in the iframe post editor](#how-to-test-your-blocks-in-the-iframe-post-editor)
...
## [Technical considerations for the iframe editor](#technical-considerations-for-the-iframe-editor)
...
### [Document and window](#document-and-window)
...
### [Using useRefEffect (recommended)](#using-userefeffect-recommended)

If you attach event handlers, remember that the `useEffect` callback will not be called if the ref changes, so it is good practice to use the new `useRefEffect` API, which _will_ call the given callback if the ref changes in addition to any dependencies passed.
...
### [Other frameworks and libraries](#other-frameworks-and-libraries)
...
### [What if the library uses global window or document and it’s out of your control?](#what-if-the-library-uses-global-window-or-document-and-its-out-of-your-control)
