...
generatedAt: 2025-12-30T18:15:52.708Z
---
...
## [Compatible blocks and their attributes](#compatible-blocks-and-their-attributes)
...
## [Registering a custom source](#registering-a-custom-source)
...
#### [Block bindings source value filter](#block-bindings-source-value-filter)
...
#### [Server registration Core examples](#server-registration-core-examples)
...
#### [Editor registration Core examples](#editor-registration-core-examples)
...
## [Unregistering a source](#unregistering-a-source)
...
## [Getting all sources](#getting-all-sources)
...
## [Getting one specific source](#getting-one-specific-source)
...
## [Block Bindings Utils](#block-bindings-utils)
