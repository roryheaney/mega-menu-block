...
generatedAt: 2025-12-30T18:16:45.536Z
---
...
### [anchor: Element | VirtualElement | null](#anchor-element-virtualelement-null)
...
### [anchorRect: DomRectWithOwnerDocument](#anchorrect-domrectwithownerdocument)
...
### [anchorRef: Element | PopoverAnchorRefReference | PopoverAnchorRefTopBottom | Range](#anchorref-element-popoveranchorrefreference-popoveranchorreftopbottom-range)
...
### [expandOnMobile: boolean](#expandonmobile-boolean)
...
### [focusOnMount: ‘firstElement’ | boolean](#focusonmount-firstelement-boolean)
...
### [onFocusOutside: ( event: SyntheticEvent ) => void](#onfocusoutside-event-syntheticevent-void)
...
### [getAnchorRect: ( fallbackReferenceElement: Element | null ) => DomRectWithOwnerDocument](#getanchorrect-fallbackreferenceelement-element-null-domrectwithownerdocument)
...
### [isAlternate: boolean](#isalternate-boolean)
...
### [placement: ‘top’ | ‘top-start’ | ‘top-end’ | ‘right’ | ‘right-start’ | ‘right-end’ | ‘bottom’ | ‘bottom-start’ | ‘bottom-end’ | ‘left’ | ‘left-start’ | ‘left-end’ | ‘overlay’](#placement-top-top-start-top-end-right-right-start-right-end-bottom-bottom-start-bottom-end-left-left-start-left-end-overlay)
...
### [position: \[yAxis\] \[xAxis\] \[optionalCorner\]](#position-yaxis-xaxis-optionalcorner)
...
### [variant: ‘toolbar’ | ‘unstyled’](#variant-toolbar-unstyled)
