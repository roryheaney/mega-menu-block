...
generatedAt: 2025-12-30T18:16:47.303Z
---
...
#### [authorList: Author\[\]](#authorlist-author)
...
#### [categoriesList: Category\[\]](#categorieslist-category)
...
#### [categorySuggestions: Record< Category\[ ‘name’ \], Category >](#categorysuggestions-record-category-name-category)
...
#### [onAuthorChange: ( newAuthor: string ) => void](#onauthorchange-newauthor-string-void)
...
#### [onCategoryChange: ( newCategory: string ) => void | FormTokenFieldProps\[ ‘onChange’ \]](#oncategorychange-newcategory-string-void-formtokenfieldprops-onchange)
...
#### [onNumberOfItemsChange: ( newNumber?: number ) => void](#onnumberofitemschange-newnumber-number-void)
...
#### [onOrderChange: ( newOrder: ‘asc’ | ‘desc’ ) => void](#onorderchange-neworder-asc-desc-void)
...
#### [onOrderByChange: ( newOrderBy: ‘date’ | ‘title’ ) => void](#onorderbychange-neworderby-date-title-void)
...
#### [orderBy: ‘date’ | ‘title’ | ‘menu\_order’](#orderby-date-title-menu_order)
...
#### [orderByOptions: OrderByOption\[\]](#orderbyoptions-orderbyoption)
...
#### [selectedAuthorId: number](#selectedauthorid-number)
