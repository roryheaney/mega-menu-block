...
generatedAt: 2025-12-30T18:17:06.722Z
---
...
###### [onFocusRow: ( event: KeyboardEvent, startRow: HTMLElement, destinationRow: HTMLElement ) => void](#onfocusrow-event-keyboardevent-startrow-htmlelement-destinationrow-htmlelement-void)
...
###### [onCollapseRow: ( row: HTMLElement ) => void](#oncollapserow-row-htmlelement-void)

A callback that passes in the row element to be collapsed.

*   Required: No

###### [onExpandRow: ( row: HTMLElement ) => void](#onexpandrow-row-htmlelement-void)
...
###### [positionInSet: number](#positioninset-number)
