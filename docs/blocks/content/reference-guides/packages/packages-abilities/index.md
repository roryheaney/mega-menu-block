...
source: "https://developer.wordpress.org/block-editor/reference-guides/packages/packages-abilities/"
generatedAt: 2025-12-30T18:17:38.847Z
---
...
### [As a WordPress Script](#as-a-wordpress-script)
...
### [Using with React and WordPress Data](#using-with-react-and-wordpress-data)
...
#### [getAbilities( args: AbilitiesQueryArgs = {} ): Ability\[\]](#getabilities-args-abilitiesqueryargs-ability)
...
#### [getAbility( name: string ): Ability | undefined](#getability-name-string-ability-undefined)
...
#### [getAbilityCategories(): AbilityCategory\[\]](#getabilitycategories-abilitycategory)
...
#### [getAbilityCategory( slug: string ): AbilityCategory | undefined](#getabilitycategory-slug-string-abilitycategory-undefined)
...
#### [registerAbility( ability: Ability ): void](#registerability-ability-ability-void)
...
#### [registerAbilityCategory( slug: string, args: AbilityCategoryArgs ): void](#registerabilitycategory-slug-string-args-abilitycategoryargs-void)
...
#### [unregisterAbilityCategory( slug: string ): void](#unregisterabilitycategory-slug-string-void)
...
#### [unregisterAbility( name: string ): void](#unregisterability-name-string-void)
...
#### [executeAbility( name: string, input?: Record<string, any> ): Promise<any>](#executeability-name-string-input-recordstring-any-promiseany)
