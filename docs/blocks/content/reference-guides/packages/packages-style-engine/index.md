...
generatedAt: 2025-12-30T18:18:40.734Z
---
...
*   _$block\_styles_ `array` A block’s `attributes.style` object or the top level styles in theme.json
*   _$options_ `array<string|boolean>` An array of options to determine the output.
    ...
    *   _convert\_vars\_to\_classnames_ `boolean` Whether to skip converting CSS var:? values to var( –wp–preset–\* ) values. Default is `false`.
...
### [wp\_style\_engine\_get\_stylesheet\_from\_css\_rules()](#wp_style_engine_get_stylesheet_from_css_rules)
...
### [wp\_style\_engine\_get\_stylesheet\_from\_context()](#wp_style_engine_get_stylesheet_from_context)

Returns compiled CSS from a stored context, if found.

_Parameters_

*   _$store\_name_ `string` An identifier describing the origin of the style object, e.g., ‘block-supports’ or ‘ global-styles’. Default is ‘block-supports’.
...
## [Installation (JS only)](#installation-js-only)
...
Performs compilation and optimization on stored CSS rules. See the class \`[WP\_Style\_Engine\_Processor](https://developer.wordpress.org/reference/classes/wp_style_engine_processor/)\`.

Store

A data object that contains related styles. See the class \`[WP\_Style\_Engine\_CSS\_Rules\_Store](https://developer.wordpress.org/reference/classes/wp_style_engine_css_rules_store/)\`.
