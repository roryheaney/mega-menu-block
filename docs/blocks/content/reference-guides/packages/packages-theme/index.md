...
slug: "packages-theme"
source: "https://developer.wordpress.org/block-editor/reference-guides/packages/packages-theme/"
generatedAt: 2025-12-30T18:18:42.872Z
---
...
Color palettes including primitive color ramps and semantic color tokens for backgrounds, foregrounds, strokes, and focus states

`dimension.json`

Spacing scale and semantic spacing tokens for padding, margins, and sizing

`typography.json`

Font family stacks, font sizes, and line heights
...
Shadow definitions for creating depth and layering
...
Color values for backgrounds, foregrounds, and strokes

`dimension`

Spacing, sizing, and other measurable lengths (e.g., padding, margins, widths)

`border`

Border properties like radius and width

`elevation`

Shadow definitions for layering and depth

`font`

Typography properties like family, size, and line-height
...
Container or layout backgrounds and borders
...
Static content like text and icons

`track`

Track components like scrollbars and slider tracks

`thumb`

Thumb components like scrollbar thumbs and slider handles
...
#### [Color Token Modifiers](#color-token-modifiers)
...
Neutrally toned UI elements

`brand`

Brand-accented or primary action colors
...
Informational or system-generated context

`caution`

Heads-up or low-severity issues; “proceed carefully”

`warning`

Higher-severity or time-sensitive issues that require user attention but are not errors

`error`

Blocking issues, validation failures, or destructive actions
...
Higher contrast and/or elevated emphasis

`weak`

Subtle variant for secondary or muted elements
...
Hovered, pressed, or selected state

`disabled`

Unavailable or inoperable state
...
### [Nesting Providers](#nesting-providers)
...
### [plugin-wpds/no-unknown-ds-tokens](#plugin-wpds-no-unknown-ds-tokens)
...
### [plugin-wpds/no-setting-wpds-custom-properties](#plugin-wpds-no-setting-wpds-custom-properties)
