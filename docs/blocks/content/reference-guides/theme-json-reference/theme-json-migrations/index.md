...
generatedAt: 2025-12-30T18:19:00.925Z
---
...
### [How to migrate from v1 to v2:](#how-to-migrate-from-v1-to-v2)

1.  Update `version` to `2`.
2.  Rename the properties that were updated (see below) if you’re using them.

Refer to the [dev note for the release](https://make.wordpress.org/core/2022/01/08/updates-for-settings-styles-and-theme-json/) and the [reference documents](https://developer.wordpress.org/block-editor/reference-guides/theme-json-reference/) for the respective v1 and v2 versions.
...
### [Changes to property values](#changes-to-property-values)
...
### [How to migrate from v2 to v3:](#how-to-migrate-from-v2-to-v3)
...
#### [settings.typography.defaultFontSizes](#settings-typography-defaultfontsizes)
...
#### [settings.spacing.defaultSpacingSizes](#settings-spacing-defaultspacingsizes)
